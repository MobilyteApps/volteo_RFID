...
public class KillCommand extends AsciiSelfResponderCommandBase implements IAntennaParameters, ICommandParameters, IQAlgorithmParameters, IQueryParameters, IResponseParameters, ISelectControlParameters, ISelectMaskParameters, ITransponderParameters, ITransponderReceivedDelegate {
    ...
    public static KillCommand synchronousCommand() {
        ...
        killCommand.setSynchronousCommandResponder(killCommand);
        return killCommand;
    }
    ...
    public void buildCommandLine(StringBuilder sb) {
        ...
        if (getKillPassword().length() != 8) {
            throw new IllegalArgumentException(String.format(Constants.ERROR_LOCALE, "Invalid access password length (%s). Must be 8 Ascii hex chars.", new Object[]{Integer.valueOf(getKillPassword().length())}));
        }
        sb.append(String.format("-kp%s", new Object[]{getKillPassword()}));
    }
    ...
    public final String getKillPassword() {
        return this.privateKillPassword;
    }
    ...
    public boolean responseDidReceiveParameter(String str) {
        if (!AntennaParameters.parseParameterFor(this, str) && !ResponseParameters.parseParameterFor(this, str) && !TransponderParameters.parseParameterFor(this, str) && !QueryParameters.parseParameterFor(this, str) && !QAlgorithmParameters.parseParameterFor(this, str) && !SelectControlParameters.parseParameterFor(this, str) && !SelectMaskParameters.parseParameterFor(this, str) && !CommandParameters.parseParameterFor(this, str)) {
            ...
            } else if (str.length() < 2 || !str.startsWith("kp")) {
                return super.responseDidReceiveParameter(str);
            } else {
                setKillPassword(str.substring(2).trim());
            }
        }
        return true;
    }
    ...
    public final void setKillPassword(String str) {
        this.privateKillPassword = str;
    }

...
public class FindModel extends ModelBase {
    ...
    /* access modifiers changed from: private */
    public Date mLastLowLevelSignalTime;
    private double mMaxRssiValue;
    private double mMinRssiValue;
    /* access modifiers changed from: private */
    public boolean mMultipleTargetsDetected;
    /* access modifiers changed from: private */
    public boolean mMultipleTranspondersInRange;
    ...
    /* access modifiers changed from: private */
    public ITargetIdentifier mTargetIdentifier = null;
    /* access modifiers changed from: private */
    public Date mTimeOfLastMultipleTargetDetection;
    /* access modifiers changed from: private */
    public a mToneGenerator;
    /* access modifiers changed from: private */
    public double mTransponderRSSI;
    private int mTranspondersReadInLastSecond;
    private Timer mUpdateTimer;
    private TimerTask mUpdateTimerTask;
    /* access modifiers changed from: private */
    public boolean mUseLowLevelSignalTone;
    /* access modifiers changed from: private */
    public boolean mWaitingForFirstMatchingTransponderInRound;
            ...
            public void transponderReceived(TransponderData transponderData, boolean z) {
                ...
                if ( getScanState() == ScanState.SCANNING) {
                    if (epc != null &&  mTargetIdentifier.isMatch(epc)) {
                        ...
                        // TODO: 09-03-2020 Here
//                        FlutterVolteoPlugin.rssiStreamHandler.sendRSSI(FindModel.this.normaliseRssiValue(FindModel.this.mTransponderRSSI*2));
                    }
                    if (!z) {
         ...
         mSwitchResponder.setSwitchStateReceivedDelegate(new ISwitchStateReceivedDelegate() {
            public void switchStateReceived(SwitchState switchState) {
                if (switchState == SwitchState.DOUBLE || switchState == SwitchState.OFF) {
                     stopScanning();
                    // TODO: 09-03-2020 here
//                    FlutterVolteoPlugin.rssiStreamHandler.sendRSSI(0.0);
    ...
    private void updatePowerRampingSettings() {
             ...
             mPowerRamp.setEnabled( false);
             mPowerRamp.setMinimumPowerRampLevel( 2);
             mPowerRamp.setMaximumPowerRampLevel(30);
             mPowerRamp.setPowerReductionThreshold(50/ 100.0d);
        ...
        performSilentTask(new Runnable() {
            public void run() {
                ...
                try {
                   ...
                   /* if ( mSharedPreferences != null &&  mSharedPreferences.getBoolean(FindModel.PREF_KEY_THRESHOLD_ENABLED, false)) {
                        double d2 = 50 / 100.0d;
                        if (normalisedRssi > 0.0d && normalisedRssi < d2) {
                            if ( mSharedPreferences.getBoolean(FindModel.PREF_KEY_THRESHOLD_LOWER_ENABLED, false) && normalisedRssi >=
                                    ((double)  mSharedPreferences.getInt(FindModel.PREF_KEY_THRESHOLD_LOWER_LEVEL, 25)) / 100.0d) {
                 ...
                 /*   if ( mSharedPreferences != null &&  mSharedPreferences.getBoolean(FindModel.PREF_KEY_THRESHOLD_LOWER_ENABLED, false)
                            &&  mLastLowLevelSignalTime != null && new Date().getTime() -  mLastLowLevelSignalTime.getTime() > 800) {
                         mUseLowLevelSignalTone = false;
                    }*/
                    if (PREF_KEY_AUDIO_SWEEPING_TONE_ENABLED) {
                        ...
                        if (transponderReading.getAdjustedNormalisedRssi() > 0.0d) {
                            ...
                            d = (double) ( mUseLowLevelSignalTone ? 880 : FindModel.BASE_FREQUENCY);
                        }
                        access$2700.b(d);
                         mToneGenerator.a(transponderReading.getAdjustedNormalisedRssi() > 0.0d);
                    } else {
                        double log10 = ((FindModel.MULTIPLE_TARGETS_DETECTED_INTERVAL - Math.log10(10.0d - (9.0d * normalisedRssi))) * 3300.0d) + 220.0d;
                    ...
                    Log.e(FindModel.TAG, "Failed in UpdateReadingsForTransponder");
                }
            }
        });
    }
    ...
    public void setEnabled(boolean z) {
        General.easyPrinter("setUpModel",TAG, String.valueOf(z));
        if (z !=  mEnabled) {
             mEnabled = z;
            if (z) {
...
//         mSharedPreferences = sharedPreferences;
    ...
    public void setSearchConfiguration(IQAlgorithmParameters iQAlgorithmParameters) {
